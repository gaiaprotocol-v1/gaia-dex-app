        ...
        Layout.current.content.append(this.container = el(".home-view",
            el("section",
                el("article",
                    el("header",
                        el(".price-container",
                            el("img", { src: "/images/shared/icn/btc.svg", alt: "btc" }),
                            el("h1", "비트코인"),
                            el("p", "BTC/KRW"),
                        ),
                        el(".tab-container",
                            ...
                            el("a", "정보"),
                            el("a.setting",
                                el("img", { src: "/images/shared/icn/setting.svg", alt: "setting" }),
                            ),
                        ),
                    ),
                    el("hr"),
